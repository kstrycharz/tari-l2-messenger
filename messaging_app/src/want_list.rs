// Copied from the guessing-game-cli example in tari-project/wasm-template
...
impl WantList {
    ...
    /// Request the vault holding `resource_address` within `component_address`.
    ...
    /// Request a specific substate by ID.
